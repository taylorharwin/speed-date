$(function(){
    ...
    var newCal = $("#calbin1").datepicker({
      onSelect: function(dateText, inst){
        ...
        chart.load({columns:[['When are peeps traveling?',7,8,8,9,9,8,5,8,10,10,8,7]]});
      }
    });
  });
...
$("#jun").on('click', function(){
  ...
  $("#calbin2").datepicker({
    defaultDate: '+1m',
      ...
      chart.load({columns:[['When are peeps traveling?',7,8,8,9,9,9,5,8,10,10,8,7]]});
      }
    });
});
...
var chart = c3.generate({
    ...
    size: {
        ...
        data: {
          columns: [
      ['When are peeps traveling?',7,8,8,9,8,8,5,8,10,10,8,7]
      ],
      type:'spline'
    },
    axis: {
